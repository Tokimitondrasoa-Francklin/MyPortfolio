...
const index = ({endpoint}) => {
  ...
  return (
    <div className='flex flex-col flex-grow px-6 pt-1'>
      <h5 className='my-3 font-medium'>I’m a mining geologist, a geophysicist and a Junior full stack Developer with strong knowledge of Geographic Information System and a 
